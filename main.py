...
st.write("All data sent and recieved on this platform are hosted on a open-source cloud server so do not send")
st.write("anything that is private or confidential!")
